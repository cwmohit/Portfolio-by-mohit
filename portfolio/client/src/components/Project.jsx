...
import ProjectHead from "../Images/projectHead2.jpg";
          ...
          <div className='col-lg-4 col-md-4 col-10 m-auto'>
            <div class="card mb-3 text-white" style={{ background: "black" }}>
              ...
              <div class="card-body">
                ...
                <a type="button" href={post.link} class="btn btn-outline-light btn-block sourceCode m-auto" target="_blank"> Source Code</a>
              </div>
            </div>
          </div>
        ))
